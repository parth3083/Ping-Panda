    ...
    <div className="max-w-3xl  flex flex-col gap-8">
      <div>
        ...
        <p className="text-sm/6 text-gray-600 max-w-prose">
          {plan === "PRO"
            ? "Thank you for supporting Ping Panda. Find your increase usage limits below."
            : "Get access to more events, categories and premium features."}
        </p>
      </div>
        ...
        <Card className="border-2 border-brand-700">
          ...
          <div>
            <p className="text-2xl font-bold">
              ...
              {usageData?.eventLimit.toLocaleString() || 100}
            </p>
      ...
      <p className="text-sm text-gray-500">
        ...
        {plan !== "PRO" ? (
          ...
          >
            {" "}
            or upgrade now to increase your limit &arr;
          </span>
        ) : null}
      </p>
    </div>
