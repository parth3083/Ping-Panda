...
-- CreateEnum
CREATE TYPE "deliverySatus" AS ENUM ('PENDING', 'COMPLETED', 'FAILED');
...
CREATE TABLE "Event" (
    ...
    "userId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "deliveryStatus" "deliverySatus" NOT NULL DEFAULT 'PENDING',
...
-- AddForeignKey
ALTER TABLE "Quota" ADD CONSTRAINT "Quota_eventCategoryId_fkey" FOREIGN KEY ("eventCategoryId") REFERENCES "EventCategory"("id") ON DELETE SET NULL ON UPDATE CASCADE;
