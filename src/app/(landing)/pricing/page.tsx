...
function Page() {
  ...
  const INCLUDED_FEATURES = [
    ...
    "10 event catregories",
    "Advnaced analytics and insiights",
    "Priority support",
  ];
    ...
    <div className="bg-brand-25 py-24 sm:py-32">
      <MaxWidth>
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-base/7 text-gray-700 max-w-prose w-full text-center text-pretty">
            We hate subscriptions. And chances are, you do too. That is why we
            offer lifetime access to PingPand for a one-time payment.
          </p>
        </div>
